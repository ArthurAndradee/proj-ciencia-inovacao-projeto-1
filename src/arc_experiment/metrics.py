...
def summarize(records: Sequence[dict[str, Any]], condition: str = "") -> ConditionSummary:
    return ConditionSummary(
        ...
        thinking_tokens=sum(int(r.get("thinking_tokens", 0)) for r in records),
        truncated_answers=sum(int(r.get("truncated_answers", 0)) for r in records),
